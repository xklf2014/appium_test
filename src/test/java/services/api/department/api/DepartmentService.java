package services.api.department.api;
...
public class DepartmentService {
    ...
    public Response createDepartment(String name,int parentDepartId){
    ...
    public Response createDepartment(String name){
        return createDepartment(name,parentDepartId);
    }
